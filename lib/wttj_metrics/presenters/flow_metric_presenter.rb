...
module WttjMetrics
  module Presenters
    ...
    class FlowMetricPresenter < BasePresenter
      TOOLTIPS = {
        'avg_cycle_time_days' => "Median time from when work starts on an issue until it's completed.",
        'avg_lead_time_days' => 'Median time from issue creation to completion.',
        'avg_review_time_days' => 'Median time spent in review states (code review, testing, validation).',
